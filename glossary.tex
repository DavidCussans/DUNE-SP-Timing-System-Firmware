...
\newduneabbrev{dts-sp-tm}{timing master}{DTS-SP timing master}{Originator of master timing signals in (Proto)DUNE-SP}

\newduneabbrev{dts-sp-ep}{timing endpoint}{DTS-SP timing master}{Recipient of timing signals from the timing master in (Proto)DUNE-SP}
% 
...
\newduneword{ipbb}{IPBB}{IPBus Build, a system for building an FPGA configuration file from the source code.}